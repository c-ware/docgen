OBJS=src/arguments.o src/main.o src/libstr/replace.o src/libstr/starts.o src/libstr/count.o src/libstr/strip.o src/libstr/reverse.o src/extractors/structures/structures.o src/extractors/functions/functions.o src/extractors/macros/macros.o src/extractors/projects/projects.o src/extractors/macro_functions/macro_functions.o src/common/common.o src/common/error.o src/generators/common.o src/generators/functions.o src/libarg/libarg.o src/libmatch/read.o src/libmatch/match.o src/libmatch/cond.o src/libmatch/cursor.o src/cstring/cstring.o src/libpath/join_path.o src/libpath/mkdir.o src/libpath/exists.o src/postprocessors/postprocessors.o src/tags/tags.o 
