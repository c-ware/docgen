OBJS=./src/arguments.o ./src/main.o ./src/libarg/libarg.o ./src/libmatch/read.o ./src/libmatch/cond.o ./src/libmatch/cursor.o ./src/libmatch/match.o ./src/libstr/starts.o ./src/libstr/replace.o ./src/libstr/strip.o ./src/libstr/reverse.o ./src/libstr/count.o ./src/libpath/exists.o ./src/libpath/mkdir.o ./src/libpath/join_path.o ./src/common/error.o ./src/common/common.o ./src/tags/tags.o ./src/targets/projects/projects.o ./src/targets/projects/backends/manpage.o ./src/targets/projects/backends/helpcms.o ./src/targets/projects/backends/dcfscript.o ./src/targets/macros/macros.o ./src/targets/macros/backends/manpage.o ./src/targets/functions/functions.o ./src/targets/functions/backends/markdown.o ./src/targets/functions/backends/manpage.o ./src/extractors/structures/structures.o ./src/extractors/macros/macros.o ./src/extractors/macro_functions/macro_functions.o ./src/extractors/functions/functions.o 
...
./src/targets/functions/backends/markdown.o: ./src/targets/functions/backends/markdown.c
